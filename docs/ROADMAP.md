...
- **El sitio web público de consulta de la boleta.** El correo lo reitera: señalado en la representación impresa y **disponible en la web previa aprobación a su certificación**. El PDF no imprime ninguna URL y el sitio no existe. No bloqueó las 24 horas del set: el PDF se renderiza a pedido desde el XML almacenado, así que los definitivos se generan después, ya con la URL.
