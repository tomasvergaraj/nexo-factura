...
class FirmaDentroDelSobreTest {
    ...
    static void inicializar() throws Exception {
        ...
        generadorBoleta = new EnvioBoletaGenerator(firma, validator, certificado, props);
        generadorDte = new EnvioDteGenerator(firma, validator, certificado, props);
    }
    ...
    void firmaBoletaVerificaEnElSobre() throws Exception {
        ...
        String sobre = generadorBoleta.generar(new SiiGateway.EnvioSii(dte, 39, 1L, DteFixtures.RUT_EMISOR));
    ...
    void firmaFacturaVerificaEnElSobre() throws Exception {
        ...
        String sobre = generadorDte.generar(new SiiGateway.EnvioSii(dte, 33, 1L, DteFixtures.RUT_EMISOR));
        assertThat(verificarFirmaDelDocumento(sobre)).as("firma del DTE en contexto del sobre").isTrue();
        assertThat(verificarFirmaDelSetDte(sobre))
                .as("firma del SetDTE tras re-declarar namespaces del DTE interno").isTrue();
